...
class Http
{
    ...
    public static function decode($recv_buffer, TcpConnection $connection)
    {
        ...
        log_message("debug", "http原始数据===>".print_r($_REQUEST,TRUE));
        $sc = new Security();
        $_POST = $sc->xss_clean($_POST);
        $_GET = $sc->xss_clean($_GET);
        $_REQUEST = $sc->xss_clean($_REQUEST);
